...
public class MainActivity extends AppCompatActivity
    ...
    public static final String TAG = "MayDayApp";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        fragmentClass = MisVuelosActivity.class;
        try {
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.mis_vuelos) {
            // Handle the camera action
            fragmentClass = MisVuelosActivity.class;
        } else if (id == R.id.ofertas) {
            fragmentClass = OfertasActivity.class;
        } else if (id == R.id.opiniones) {
            fragmentClass = OpinionesActivity.class;
        } else if (id == R.id.config) {
            fragmentClass = ConfigActivity.class;
        }
